...
export const translations: Record<string, { ar: string; en: string }> = {
  ...
  'nav.submitReport': { ar: 'تسجيل تقرير', en: 'Submit Report' },
  'nav.teamReports': { ar: 'تقارير الفريق', en: 'Team Reports' },
  'nav.submitActivity': { ar: 'تسجيل نشاط', en: 'Submit Activity' },
  'nav.myWeeklyPlan': { ar: 'خطتي الأسبوعية', en: 'My Weekly Plan' },
  ...
  'login.description': { ar: 'سجّل الدخول للوصول إلى مساحة العمل المناسبة لمنصبك', en: 'Sign in to access your position-aware workspace' },
  'login.username': { ar: 'اسم المستخدم', en: 'Username' },
  'login.usernamePlaceholder': { ar: 'اسم المستخدم', en: 'Username' },
  'login.password': { ar: 'كلمة المرور', en: 'Password' },
  'login.passwordPlaceholder': { ar: 'كلمة المرور', en: 'Password' },
  'login.signIn': { ar: 'تسجيل الدخول', en: 'Sign In' },
  'login.required': { ar: 'يرجى إدخال اسم المستخد وكلمة المرور', en: 'Please enter username and password' },
  'login.invalid': { ar: 'اسم المستخد أو كلمة المرور غير صحيحة', en: 'Invalid username or password' },
  'login.locked': { ar: 'تم قفل الحساب مؤقتاً بسبب تكرار المحاولات الخاطئة', en: 'Account temporarily locked due to repeated failed attempts' },
  ...
  'admin.sections': { ar: 'أقسام الإدارة', en: 'Admin sections' },
